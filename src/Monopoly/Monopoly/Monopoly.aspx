            ...
            <table  class="monopolyTable">
                ...
                <tbody>
                    <tr style="text-align: center;">
                        ...
                        <td>
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                                title="Indiana Avenue">Indiana Avenue</a><br>($220)
                        </td>
                        <td>
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                                title="Illinois Avenue">Illinois Avenue</a><br>($240)
                        </td>
                        <td rowspan="2">
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                                title="B. &amp; O. Railroad">B. &amp; O. Railroad</a><br>($200)
                        </td>
                        <td>
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                        ...
                        <td rowspan="2">
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                                title="Water Works">Water Works</a><br>($150)
                        </td>
                        <td>
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                                title="Marvin Gardens">Marvin Gardens</a><br>($280)
                        </td>
                        <td colspan="2" rowspan="2">
                            Go To Jail
                        </td>
                    ...
                    <tr style="text-align: center;">
                        <td>
                            <a href="" onclick="window.open('items.aspx', 'ITEMS', 'width=340, height=300'); return false;" 
                                title="Tennessee Avenue">Tennessee Avenue</a><br>($180)
                        </td>
                        <td bgcolor="#ff8000">
                        </td>
                        <td bgcolor="#338033">
